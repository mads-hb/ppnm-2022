...
static class MainProgram{
    ...
    public static int Main(){
        ...
        (var res1, var err1) = MonteCarlo.pseudo(f1, a1, b1, 10000);
        ...
        (var res2, var err2) = MonteCarlo.pseudo(f2, a2, b2, 1000000);
        ...
        (var res3, var err3) = MonteCarlo.pseudo(f3, a3, b3, 10000000);
